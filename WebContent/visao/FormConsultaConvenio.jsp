...
<script type="text/javascript" language="javascript">
	...
	function consultar() {
		document.formConsultaConvenio.acao.value = "ConsultarConvenio";
		document.formConsultaConvenio.submit();
	}
...
<jsp:include page="Cabecalho.jsp" />
	<div id="principal">
		<div id="titulo">
			<h3>Controle de Convenios - consultar</h3>
		</div>
		<hr>
		<div id="formulario2">
			<form name="formConsultaConvenio" action="/sce-web-ref2/ServletControle" method="post">
				<table id="tabcampos">
					<tr>
