...
public class Fachada {
	...
	public ArrayList<Convenio> listaConvenio() {
		...
		return convenioRepositorio.listaConvenio();
	}
	...
	public String alterarUsuario(Usuario u) {
		String codigoRetorno = "";
		try {
			codigoRetorno = usuarioRepositorio.altera(usuario);
		} catch (Exception e) {
			codigoRetorno = e.getMessage();
		}
		return codigoRetorno;
	...
	public String alterarUsuario(String nome, String userID, String senha) {
		usuario = new Usuario();
	...
	public List<EstagioSupervisionado> consultaRelatorioEstagioSupervisionado() {
		
		List<EstagioSupervisionado> l =  estagioSupervisionadoRepositorio.findAll();
		
		
		return l;
	}
	
	public String incluirUpload(String nomeArquivo) {
		logger.info(" >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>obtem parametro do nome Arquivo =" + nomeArquivo);
		return nomeArquivo;
